...
=head1 recs-delta --help-all
 ...
 Arguments:
    --key|-k <keys>              Comma separated list of the fields that should be transformed. Fields not in this list will be passed through unchanged, using the *first* record of each delta pair. This may be a keyspec or a keygroup,
                                 see "--help-keyspecs" for more information
