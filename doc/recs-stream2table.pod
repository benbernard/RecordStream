...
=head1 recs-stream2table --help-all
 ...
 Usage: recs-stream2table <args> [<files>]
    Transforms a list of records, combinging records based on a column, FIELD. In order, the values of the column will be added to the output records.
    ...
    The full input record will be associated with the value of the FIELD. The field itself will be removed from the nested record if the passed field is not a key spec.
