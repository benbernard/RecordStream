...
{"name":"sahara","osname":"solaris","nested":{"foo":"bar","panda":"1.2.3.4"},"address":["10.0.0.101","10.0.1.101"],"osversion":"2.6"}
...
{"osversion":"2.6","element":"server","address":["10.0.0.101","10.0.1.101"],"osname":"solaris","name":"sahara","nested":[{"foo":"bar","panda":"1.2.3.4"}]}
...
App::RecordStream::Test::OperationHelper->do_match(
  'fromxml',
  [qw(--element server --element nested --nested file:tests/files/xml1)],
  '',
  $solution3,
);
