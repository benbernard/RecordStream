...
open(my $outputfh, '-|', "$bin_dir/recs-chain  recs-xform '\$r->rename(\"foo\", \"zoo\");' $base_dir/$test_file \\| recs-sort --key zoo=-n \\| grep 3  \\| recs-totable");
...
open(my $outputfh2, '-|', "$bin_dir/recs-chain  recs-xform '\$r->rename(\"foo\", \"zoo\");' $base_dir/$test_file \\| recs-sort --key zoo=-n \\| recs-totable");
$/ = undef;
